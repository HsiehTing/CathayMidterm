            ...
            do {
                if let data = data {
                    ...
                    case 0:
                        ...
                        let last2Data: IndexData? =
                        decodedData.count < 2 ? decodedData.last : decodedData[decodedData.count - 2]
