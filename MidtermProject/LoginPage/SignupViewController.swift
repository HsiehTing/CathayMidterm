...
class SignupViewController: UIViewController, SignupDelegate {
    private let questionCollectionView = UICollectionView(
        frame: .zero,
        collectionViewLayout: SignupViewController.configFlowLayout()
    )
    ...
    func passInfo(info: String, question: String) {
        ...
        if passBackArray.count == questionSets.count,
           passBackArray["密碼"] == passBackArray["再次確認密碼"],
           passBackArray["帳號"] != passBackArray["密碼"] {
    ...
    private func configCollectionView() {
        ...
        questionCollectionView.register(
            SignupCollectionviewCell.self, forCellWithReuseIdentifier: questionCollectionViewIdentifier)
...
extension SignupViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        guard let cell = collectionView.dequeueReusableCell(
            withReuseIdentifier: questionCollectionViewIdentifier,
            for: indexPath) as? SignupCollectionviewCell else { return UICollectionViewCell() }
